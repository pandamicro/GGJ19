...
cc.Class({
    ...
    start () {
        ...
        this.spBloomCut.node.height = cc.visibleRect.height * 0.9;
        ...
        this.spBloomBlend.node.height = cc.visibleRect.height * 0.9;
        ...
        const t4 = new cc.RenderTexture();
        t4.initWithSize(cc.visibleRect.width, cc.visibleRect.height, gl.DEPTH_STENCIL);
        ...
        m2.setProperty('params', cc.quat(tex_offset.x, tex_offset.y, 1, 0.227027));
        m2.setProperty('weights', cc.quat(0.1945946, 0.1216216, 0.054054, 0.016216));

        this.camBloomBlurV.targetTexture = t3;
        const m3 = this.spBloomBlurH.getMaterial(0);
        m3.setProperty('texture', t3.getImpl());
        m3.setProperty('params', cc.quat(tex_offset.x, tex_offset.y, 0, 0.227027));
        m3.setProperty('weights', cc.quat(0.1945946, 0.1216216, 0.054054, 0.016216));

        this.camBloomBlurH.targetTexture = t4;
        const m4 = this.spBloomBlend.getMaterial(0);
        m4.setProperty('origin', t1.getImpl());
        m4.setProperty('blurred', t4.getImpl());
    },
});
